function [ dataStruct ] = DriverFunction_ContDeg_hz(  )
...
if ispc 
    ...
    userdir= getenv('HOME');
    datadir = '/home/bailey/Documents/MATLAB/ContDeg/_mat';
...
cd ('C:\Users\Jacqui\Box Sync\mea_data\rrri_01\processing\contdeg\spiketrain\HZ');
