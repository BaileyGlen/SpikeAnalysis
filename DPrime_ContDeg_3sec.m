function data = DPrime_ContDeg_3sec(data,type)%% NEWEST VERSION OF SELECTIVITY_ D.N.Linsenbardt (November 2015) dlinsen1@gmail.com
close all;
for t=1:2;
...
%%%%%%%%%%%%%%%%%%%%%%%% Commenting to deal with other parts, this needs
